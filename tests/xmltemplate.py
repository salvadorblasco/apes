...
<apes version="1.0">
 ...
 <metadata>
  <!-- Some metadata that can be useful -->
 ...
 <models active="0">
  <!-- Each <model> block must contain as many <line>s as needed and the number of
       ...
       the <labels> number. -->
  <model title="optional" energy_units='kcal/mol'>
   ...
   <enthalpy>-11.20 0.28</enthalpy>      <!-- OPTIONAL. Enthalpy of this equilibrium. Required only if calorimetry data are present -->
   <enthalpy_error>0.06 0.01</enthalpy_error> <!-- OPTIONAL. Enthalpy error.  -->
   <enthalpy_key>1 0</enthalpy_key>      <!-- OPTIONAL. Required only if calorimetry data are present. refinement key (int) -->
   <enthropy>-0.22 0.19</enthropy>       <!-- OPTIONAL. Enthropy of this equilibrium. -->
   <enthropy_error>0.06 0.09</enthropy_error> <!-- OPTIONAL. Error of enthropy. -->
  </model>
 </models>
 ...
 <distri name="noname">
  ...
  <pX>False True</pX>
  <externaldata>
   <!-- Many <set> blocks are allowed -->
   <set title="y2-axis title">
    <x unit="mL">0.1 0.2 0.3 (...) 1.4</x>
    <y unit="chemical shift" label="δ / ppm">123.3 159.3 160.5 (...)</y>
   </set>
  </externaldata>
 </distri>
 ...
 <potentiometricdata title="optional" temperature="25" use="1">
   ...
   <f>1.0 1.0</f>   <!-- Optional. correction constant. Assume 1.0 by default -->
   <fRTnF>25.25 25.25</fRTnF>   <!-- Optional. Nernst's -->
   <!-- T optional -->
   <T unit="mmol/mL">0.025 0.0124 0.124</T>
   <!-- either T or titrations parms must be present -->
   <T0 unit="mmol">0.025 0.0124 0.124</T0>
   <T0key>0 0 0</T0key> <!-- Optional refinement keys -->
   <buret unit="mmol/mL">0 0 -0.1</buret>
   <V0 unit="mL">30.00 0.01</V0>
 ...
 <specdata title="optional" use='1'>
   ...
   <c>0.01 0.023 0.0134 (...)</c>
   <titre>0.00 0.02 0.04 (...)</titre>
   <!-- Many <spectra> blocks are allowed -->
   <spectra type="Absorbance" use="yes">
    <transparency>1 0 1</transparency>
 ...
 <calordata title="optional" use='1'>
   <!-- T optional -->
   <T unit="mmol/mL">0.025 0.0124 0.124</T0>
   <T0 unit="mmol">0.025 0.0124 0.124</T0>
   <T0key>0 0 0</T0key>
   <buret unit="mmol/mL">0 0 -0.1</buret>
   <V0 unit="mL">30.00 0.01</V0>
